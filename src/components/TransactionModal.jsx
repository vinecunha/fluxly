...
const categorias = [
  'Aplicativos', 'Assinaturas', 'Boletos Diversos', 'Carro', 'Casa',
  'Combustível', 'Cuidados Pessoais', 'Delivery', 'Educação',
  'Empréstimos e Financiamentos', 'Lazer', 'Lojas e Sites', 'Mercado',
  'Mesma Titularidade', 'Outros Gastos', 'Pagamento de Fatura', 'Pets',
  'Restaurantes', 'Saque', 'Saúde','Seguros', 'Telefone/Internet', 'Transferências Diversas',
  'Transporte por App', 'Transporte Público', 'Viagens',
]
      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/60 backdrop-blur-sm">
        <div className="bg-white w-full max-w-lg rounded-t-2xl p-8 shadow-2xl animate-in slide-in-from-bottom duration-300 max-h-[95vh] overflow-y-auto no-scrollbar">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Recorrência — não disponível para pagamento de fatura */}
            {!isPagamentoCartao && (
