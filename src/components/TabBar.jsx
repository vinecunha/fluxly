    ...
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/90 backdrop-blur-md border-t border-gray-100 shadow-[0_-4px_24px_rgba(0,0,0,0.06)]">
      <div className="grid grid-cols-5 items-end w-full max-w-2xl mx-auto">
        ...
        <div className="flex flex-col items-center pb-2">
          <button
            onClick={onAddNew}
            className="w-14 h-14 -mt-5 bg-slate-900 rounded-full shadow-lg shadow-slate-200 flex items-center justify-center active:scale-90 transition-all hover:bg-slate-700 border-4 border-white"
          >
