    ...
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/90 backdrop-blur-md border-t border-gray-100 shadow-[0_-4px_24px_rgba(0,0,0,0.06)]">
      <div className="grid grid-cols-4 items-end w-full">
        ...
        <div className="flex flex-col items-center pb-2">
          <button
            onClick={onAddNew}
            className="w-14 h-14 -mt-5 bg-indigo-600 rounded-full shadow-lg shadow-indigo-200 flex items-center justify-center active:scale-90 transition-all hover:bg-indigo-700 border-4 border-white"
          >
            <Plus size={24} className="text-white" strokeWidth={3} />
          </button>
          <span className="text-[8px] font-black text-indigo-600 uppercase tracking-wide mt-1">Novo</span>
        </div>
